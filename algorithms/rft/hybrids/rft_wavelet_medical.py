...
Strategy:
1. Wavelet decomposition (multi-level Haar) â†’ separates scales
2. RFT filtering on high-frequency subbands â†’ exploits quasi-periodicity in edges
...
def rft_wavelet_denoise_2d(noisy_image: np.ndarray,
    ...
    for level in range(levels - 1, -1, -1):
        ...
        # BayesShrink threshold: ÏƒÂ²_n / Ïƒ_signal
