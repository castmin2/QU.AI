...
class VariantEntry:
    """Single source of truth for a Î¦-RFT variant."""
...
# Order matters â€“ matches README/architecture docs and GUI exposure
_BASE_VARIANT_ROWS: Sequence[Tuple[str, str, Optional[str], bool]] = (
    ...
    ("PHI_CHAOTIC", "phi_chaotic_hybrid", "RFT_VARIANT_PHI_CHAOTIC", False),
    ("HYPERBOLIC", "hyperbolic_phase", "RFT_VARIANT_HYPERBOLIC", False),
    ("DCT", "dct", "RFT_VARIANT_DCT", False),
    ("HYBRID_DCT", "hybrid_dct", "RFT_VARIANT_HYBRID_DCT", False),
